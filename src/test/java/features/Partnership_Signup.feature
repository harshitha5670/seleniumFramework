Feature: Signup for Partnership

  As a user, I should be able to navigate to screen and be able to signup for Partnership section.
  ...
  Scenario: Validate user is able signup with valid data
    Then I navigate to "Partnership" signup page
    Then I validate default India country is selected in "Country of incorporation" dropdown
  ...
  Scenario: Validate user is able signup for default India country
    Then I navigate to "Partnership" signup page
    Then I select "France" in "Country of incorporation" dropdown
    Then I enter "first_name" mandatory field: "harshitha"
    Then I enter "last_name" mandatory field: "muralidhar"
    Then I enter "email" mandatory field: "hm@gmail.com"
