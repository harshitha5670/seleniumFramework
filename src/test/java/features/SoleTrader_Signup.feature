Feature: Signup for Sole Trader

  As a user, I should be able to navigate to screen and be able to signup for Sole Trader section.
  ...
  Scenario: Validate user is able signup with valid data
    Then I navigate to "Sole Trader" signup page
